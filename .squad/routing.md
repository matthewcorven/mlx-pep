...
| CLI and terminal UX | Trinity | System.CommandLine flows, Terminal.Gui interactions, user-facing harness work |
| Service and model integration | Tank | API endpoints, service layers, model runtime wiring, local workflow orchestration |
| Platform and packaging | Dozer | Build packaging, publishing, local tooling, environment setup, project automation |
| Data, model profiles, and evaluation | Neo | Profile schema work, benchmark analysis, model comparisons, local AI tooling |
